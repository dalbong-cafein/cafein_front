...
class _CafeplusScreenState extends State<CafeplusScreen> {
  ...
  void initState() {
    if(widget.address != ""){
      myController_address.text = widget.address;
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: Container(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(Icons.search , size: 24,color : CafeinColors.grey800),
                      ),
                    ),
              ...
              child: Container(
                ...
                child: IconButton(
                  ...
                  onPressed: () async {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => CafeMapScreen(y, x, hereaddress,widget.token)),
                    );
                  ...
                  icon: Container(
                    ...
                    width : width - 32 * w_percent,
                    height: h_percent * 40,
                    child: Center(child: Text("지도에서 주소 찾기",  style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500, fontFamily: 'MainFont', color : CafeinColors.grey800) ),),
                  ),
                ),
              ),
            ),
